...
const BUILD_TAG = "v15.3 — fix: chunks plus petits (throughput Gemini free tier) + comptage échec/vide corrigé (ne compte plus double) + détail réel de l'erreur par partie affiché";
